...
then
    ...
    curl -sSL https://github.com/uber/prototool/releases/download/v0.1.0/prototool-$(uname -s)-$(uname -m) > $PROTOTOOL_BIN/prototool && chmod +x $PROTOTOOL_BIN/prototool && $PROTOTOOL_BIN/prototool-h
fi
