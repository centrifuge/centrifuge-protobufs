...
type InvoiceData struct {
	...
	DueDate              *timestamp.Timestamp `protobuf:"bytes,9,opt,name=due_date,json=dueDate" json:"due_date,omitempty"`
	DateCreated          *timestamp.Timestamp `protobuf:"bytes,11,opt,name=date_created,json=dateCreated" json:"date_created,omitempty"`
