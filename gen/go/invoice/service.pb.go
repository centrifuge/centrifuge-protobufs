...
type SendInvoiceEnvelope struct {
	...
	Recipients           [][]byte         `protobuf:"bytes,1,rep,name=recipients" json:"recipients,omitempty"`
...
type InvoiceDocumentServiceClient interface {
	...
	GetReceivedInvoiceDocuments(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*ReceivedInvoices, error)
}
...
func (c *invoiceDocumentServiceClient) GetReceivedInvoiceDocuments(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*ReceivedInvoices, error) {
...
type InvoiceDocumentServiceServer interface {
	...
	GetReceivedInvoiceDocuments(context.Context, *types.Empty) (*ReceivedInvoices, error)
}
...
func _InvoiceDocumentService_GetReceivedInvoiceDocuments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InvoiceDocumentServiceServer).GetReceivedInvoiceDocuments(ctx, req.(*types.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
