...
type PurchaseOrderDocumentServiceClient interface {
	...
	GetReceivedPurchaseOrderDocuments(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*ReceivedPurchaseOrders, error)
}
...
func (c *purchaseOrderDocumentServiceClient) GetReceivedPurchaseOrderDocuments(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*ReceivedPurchaseOrders, error) {
...
type PurchaseOrderDocumentServiceServer interface {
	...
	GetReceivedPurchaseOrderDocuments(context.Context, *types.Empty) (*ReceivedPurchaseOrders, error)
}
...
func _PurchaseOrderDocumentService_GetReceivedPurchaseOrderDocuments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PurchaseOrderDocumentServiceServer).GetReceivedPurchaseOrderDocuments(ctx, req.(*types.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
