...
type CoreDocument struct {
	...
	// is used internally to store all future versions.
	//
	// 32 byte value
	...
	// signature_root is the Merkle root calculated from all fields on the document that need to be signed. This is all fields except for the signatures themselves and the `document_root`.
	SignatureRoot []byte `protobuf:"bytes,10,opt,name=signature_root,json=signatureRoot,proto3" json:"signature_root,omitempty"`
	// previous_root is the root of the previous version of the document
...
func (*CoreDocument) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_a47def746ea72e14, []int{0}
}
...
func (m *CoreDocument) GetSignatureRoot() []byte {
	if m != nil {
		return m.SignatureRoot
	}
	return nil
}
...
func (*Signature) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_a47def746ea72e14, []int{1}
}
...
func init() {
	proto.RegisterFile("coredocument/coredocument.proto", fileDescriptor_coredocument_a47def746ea72e14)
}

var fileDescriptor_coredocument_a47def746ea72e14 = []byte{
	// 358 bytes of a gzipped FileDescriptorProto
	,
}
