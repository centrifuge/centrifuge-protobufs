...
func (Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_72d83156235ea7d4, []int{0}
}
...
func (*DocumentSalt) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_72d83156235ea7d4, []int{1}
}
...
func (*AccessToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_72d83156235ea7d4, []int{2}
}
...
func (*Signature) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_72d83156235ea7d4, []int{3}
}
...
func (*Role) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_72d83156235ea7d4, []int{4}
}
...
func (*ReadRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_72d83156235ea7d4, []int{5}
}
...
func (*NFT) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_72d83156235ea7d4, []int{6}
}
...
func init() {
	proto.RegisterFile("coredocument/coredocument.proto", fileDescriptor_coredocument_72d83156235ea7d4)
}

var fileDescriptor_coredocument_72d83156235ea7d4 = []byte{
	// 864 bytes of a gzipped FileDescriptorProto
	,
}
