...
func (Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_a380ff406268fe5c, []int{0}
}
...
func (*DocumentSalt) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_a380ff406268fe5c, []int{1}
}
...
func (*AccessToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_a380ff406268fe5c, []int{2}
}
...
func (*Signature) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_a380ff406268fe5c, []int{3}
}
...
func (*Role) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_a380ff406268fe5c, []int{4}
}
...
func (*ReadRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_a380ff406268fe5c, []int{5}
}
...
func (*NFT) Descriptor() ([]byte, []int) {
	return fileDescriptor_coredocument_a380ff406268fe5c, []int{6}
}
...
func init() {
	proto.RegisterFile("coredocument/coredocument.proto", fileDescriptor_coredocument_a380ff406268fe5c)
}

var fileDescriptor_coredocument_a380ff406268fe5c = []byte{
	// 871 bytes of a gzipped FileDescriptorProto
	,
}
