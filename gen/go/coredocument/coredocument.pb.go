...
func (m *AccessControlEntry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AccessControlEntry.Marshal(b, m, deterministic)
}
func (dst *AccessControlEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccessControlEntry.Merge(dst, src)
}
func (m *AccessControlEntry) XXX_Size() int {
	return xxx_messageInfo_AccessControlEntry.Size(m)
}
func (m *AccessControlEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_AccessControlEntry.DiscardUnknown(m)
}

var xxx_messageInfo_AccessControlEntry proto.InternalMessageInfo
...
type AccessControlSchema struct {
	...
	GrantAccessToFutureVersionsUntil *timestamp.Timestamp `protobuf:"bytes,4,opt,name=grant_access_to_future_versions_until,json=grantAccessToFutureVersionsUntil" json:"grant_access_to_future_versions_until,omitempty"`
...
func (m *AccessControlSchema) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AccessControlSchema.Marshal(b, m, deterministic)
}
func (dst *AccessControlSchema) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccessControlSchema.Merge(dst, src)
}
func (m *AccessControlSchema) XXX_Size() int {
	return xxx_messageInfo_AccessControlSchema.Size(m)
}
func (m *AccessControlSchema) XXX_DiscardUnknown() {
	xxx_messageInfo_AccessControlSchema.DiscardUnknown(m)
}

var xxx_messageInfo_AccessControlSchema proto.InternalMessageInfo
...
func (m *AccessControlSchema) GetGrantAccessToFutureVersionsUntil() *timestamp.Timestamp {
	if m != nil {
...
func (m *FieldAccess) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FieldAccess.Marshal(b, m, deterministic)
}
func (dst *FieldAccess) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FieldAccess.Merge(dst, src)
}
func (m *FieldAccess) XXX_Size() int {
	return xxx_messageInfo_FieldAccess.Size(m)
}
func (m *FieldAccess) XXX_DiscardUnknown() {
	xxx_messageInfo_FieldAccess.DiscardUnknown(m)
}

var xxx_messageInfo_FieldAccess proto.InternalMessageInfo
