...
// NotificationMessage wraps a single CoreDocument to be notified
...
func (*NotificationMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_notification_3bcdf2fa2f528250, []int{0}
}
...
func init() {
	proto.RegisterFile("notification/notification.proto", fileDescriptor_notification_3bcdf2fa2f528250)
}

var fileDescriptor_notification_3bcdf2fa2f528250 = []byte{
