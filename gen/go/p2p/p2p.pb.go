...
type P2PMessage struct {
	...
	// cent_node_version is a 9-digit concatenated semver version of the node client.
	// MMMmmmppp -> MMM.mmm.ppp (Major.Minor.Patch)
	CentNodeVersion uint32 `protobuf:"varint,2,opt,name=cent_node_version,json=centNodeVersion" json:"cent_node_version,omitempty"`
...
func (*P2PMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_p2p_ce98553b5c52c959, []int{0}
}
...
func (m *P2PMessage) GetCentNodeVersion() uint32 {
	if m != nil {
...
type P2PReply struct {
	CentNodeVersion      uint32                     `protobuf:"varint,1,opt,name=cent_node_version,json=centNodeVersion" json:"cent_node_version,omitempty"`
...
func (*P2PReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_p2p_ce98553b5c52c959, []int{1}
}
...
func (m *P2PReply) GetCentNodeVersion() uint32 {
	if m != nil {
		return m.CentNodeVersion
	}
	return 0
...
func init() { proto.RegisterFile("p2p/p2p.proto", fileDescriptor_p2p_ce98553b5c52c959) }

var fileDescriptor_p2p_ce98553b5c52c959 = []byte{
	// 261 bytes of a gzipped FileDescriptorProto
	,
}
